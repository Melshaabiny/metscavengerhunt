...
class QuestionAsked(models.Model):
    ...
    has *title*, *description* and the *status* which indicate
    if the question is answered or not. This model should be
...
class Answered(models.Model):
    ...
    questionBy = models.ForeignKey(QuestionAsked) # answer <many> - to - <one> question.
